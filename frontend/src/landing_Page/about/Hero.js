...
function Hero() {
  return (
    <div className="container p-5">
      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8em"}}>
        <div className="col">
          <p className="mt-5">
        ...
        <div className="col">
          <p className="mt-5">
            ...
            up on the latest updates on our <a href="" style={{textDecoration:"none"}}>blog</a> or see what the media is <a href="" style={{textDecoration:"none"}}>saying about us</a>
            or learn more about our business and product <a href="" style={{textDecoration:"none"}}>philosophies</a>.
          </p>
        </div>
      </div>
    </div>
